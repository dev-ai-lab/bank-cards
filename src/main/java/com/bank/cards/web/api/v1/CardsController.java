package com.bank.cards.web.api.v1;
...
public class CardsController {
    ...
    public ResponseEntity<CardsDto> fetchCardDetails(@RequestHeader("bank-correlation-id") String correlationId,
        ...
        logger.debug("fetchCardDetails method start"); // open telemetry will add tag, trace-id and span-id
    ...
    public ResponseEntity<CardsContactInfoDto> getContactInfo() {
        logger.info("get contact Information");
        return ResponseEntity
                .status(HttpStatus.OK)
